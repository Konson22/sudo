    ...
    <div className="md:px-[8%] px-6 md:py-[3rem] py-[1rem]">
      <h2 
        className="
          ...
          md:text-5xl text-4xl font-bold md:text-center
          "
        >
          Our Services
      </h2>
        ...
        {data.map(service => (
          <div className='md:mb-0 mb-6 p-5 shadow bg-lightblue text-white'>
            <div className="flex items-center mb-5">
              ...
              <h2 className="flex-1 text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-pink-600 ">{service.title}</h2>
            </div>
